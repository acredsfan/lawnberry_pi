...
class ToFSensorManager:
    ...
    async def _setup_shutdown_pins(self):
        ...
        for config in self.sensor_configs:
            try:
                ...
                # Since board.D22/D23 may not be available, use GPIO adapter
    ...
    async def _initialize_sensors_sequence(self):
        ...
        # Use GPIO adapter to support both Pi 4 and Pi 5
    ...
    async def _cleanup(self):
        ...
        try:
            ...
            # Turn off all sensors using GPIO adapter with timeout protection
            ...
            try:
                # Use GPIO adapter to manage pin state
                GPIO.cleanup()
            except:
                pass
