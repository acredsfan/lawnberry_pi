...
from .data_structures import (
    ...
    VisionFrame, VisionConfig, SAFETY_LEVELS, SAFETY_DISTANCES
)
...
class ObjectDetector:
    ...
    async def _process_detections(self, raw_detections: List[Dict[str, Any]], 
                                frame_width: int, frame_height: int) -> List[DetectedObject]:
    ...
    def get_detection_stats(self) -> Dict[str, Any]:
        ...
        if self._detection_stats['processing_times']:
            avg_processing_time = sum(self._detection_stats['processing_times']) / len(self._detection_stats['processing_times'])
