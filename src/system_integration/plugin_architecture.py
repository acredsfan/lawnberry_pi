...
class PluginValidator:
    ...
    async def _validate_security(self, plugin_path: Path, metadata: PluginMetadata) -> Dict[str, Any]:
    ...
    async def get_plugin_status(self, plugin_name: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "metrics": {
                ...
                "last_executed": plugin.metrics.last_executed.isoformat() if plugin.metrics.last_executed else None
            },
            "metadata": {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--plugin-type", choices=[t.value for t in PluginType], 
                       default="service", help="Plugin type")
