...
async def test_sensor_fusion_outputs_fused_position_with_accuracy():
    ...
    async with httpx.AsyncClient(transport=transport, base_url=BASE_URL) as client:
        ...
        # await client.post("/api/v2/debug/gps/inject", json={"lat": 37.0, "lon": -122.0, "accuracy_m": 0.8})
        # await client.post("/api/v2/debug/imu/inject", json={"yaw": 90.0})
        # await client.post("/api/v2/debug/odometry/inject", json={"distance_m": 1.0})
