...
| `backend/src/api/docs.py` | Docs-hub support endpoints for listing bundled documentation metadata and recording verification evidence with requirement validation. | API/Docs & verification | Endpoints: `GET /api/v2/docs/list`, `GET /api/v2/docs/bundle(simulate_checksum_mismatch?)`, `POST /api/v2/verification-artifacts`. |
