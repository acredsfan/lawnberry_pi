...
class EnhancedHardwareDetector:
    ...
    async def _test_camera_capture(self) -> Dict[str, Any]:
        ...
        if not camera_info or not camera_info.detected:
            return {"error": "No camera detected"}

        try:
            if camera_info.details.get("type") == "picamera" and picamera2:
                picam2 = picamera2.Picamera2()
    ...
    async def _detect_system_info_enhanced(self) -> Dict[str, HardwareDetectionResult]:
        ...
        try:
            ...
            system_details = {
                "pi_model": pi_model,
                "hardware_generation": hardware_gen,
                "memory_mb": memory_mb,
                "os": os_info,
